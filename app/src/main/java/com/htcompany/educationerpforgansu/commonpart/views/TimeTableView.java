...
import com.htcompany.educationerpforgansu.workpart.techarepart.dailogs.ClassTableDetialsDailog;
...
//                    Toast.makeText(getContext(), "星期" + week + "第" + (start + num) + "节", Toast.LENGTH_LONG).show();
    ...
    private View getMode(final TimeTableModel model) {
        ...
        mTimeTableNameView.setText(model.getName());//课程名称
        ...
        mTimeTableView.setBackgroundDrawable(getContext().getResources()
                .getDrawable(colors[getColorNum(model.getName())]));//设置背景
...
//                Toast.makeText(getContext(), model.getName() + "@" + model.getClassroom(), Toast.LENGTH_LONG).show();
                //展示课程详情
                ClassTableDetialsDailog detialsDailog = new ClassTableDetialsDailog(getContext(),model);
                detialsDailog.show();
            }
        });
        return mTimeTableView;
