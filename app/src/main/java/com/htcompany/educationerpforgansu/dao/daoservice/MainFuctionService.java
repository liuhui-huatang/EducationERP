...
import com.htcompany.educationerpforgansu.dao.entity.MainFuctionEntity;
 ...
 */
public class MainFuctionService extends XUtilsDbDao<MainFuctionEntity>{
    private XUtilsDbDao xUtilsDbDao;
    public MainFuctionService(Context context) {
        super(context);
        xUtilsDbDao = new XUtilsDbDao<MainFuctionEntity>(context);
    }
    /**
     * 保存实体类
     * @param entity
