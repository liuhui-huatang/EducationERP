...
import com.htcompany.educationerpforgansu.homepart.fragments.MyPunishmentFragment;
import com.htcompany.educationerpforgansu.homepart.fragments.MyRewardsFragment;
...
public class MyPrizeInfoActivity extends BaseFragmenetActivity implements View.OnClickListener{
    ...
    private MyRewardsFragment rewardsFragment;
    private MyPunishmentFragment punishmentFragment;
    ...
    public void initDatas(){
        rewardsFragment = new MyRewardsFragment();
        punishmentFragment = new MyPunishmentFragment();
    }
