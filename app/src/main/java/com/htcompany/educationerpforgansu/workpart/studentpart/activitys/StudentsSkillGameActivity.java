...
import com.htcompany.educationerpforgansu.workpart.studentpart.adapters.StuentsSkillGameAdapter;

/**
 * 技能大赛
 * Created by wrb on 2016/11/23.
 */
public class StudentsSkillGameActivity extends BaseActivity implements View.OnClickListener{
    private TextView title, rightthree_btn_tv;
    private RelativeLayout reback_btn, right_three_btn;
    private SwipeMenuListView studnetskillgame_lv;
    private StuentsSkillGameAdapter gameAdapter;
    Intent intent = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.stuentsskillgame_activity);
        initViews();
        initViewValues();
        initOnclicEvents();
    }
    ...
    public void initViews() {
        ...
        studnetskillgame_lv = (SwipeMenuListView) this.findViewById(R.id.studnetskillgame_lv);
        gameAdapter = new StuentsSkillGameAdapter(this);
        studnetskillgame_lv.setAdapter(gameAdapter);
    ...
    public void initOnclicEvents() {
        ...
        studnetskillgame_lv.setOnItemClickListener(bookManageClicer);
    }
    public AdapterView.OnItemClickListener bookManageClicer = new AdapterView.OnItemClickListener() {
        @Override
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            //调到公告详情界面
            intent = new Intent(StudentsSkillGameActivity.this, StudentsSkillGameDetailsActiviy.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.right_three_btn:
                //调到添加技能大赛界面
                intent = new Intent(StudentsSkillGameActivity.this, StudentsSkillGameAddActivity.class);
                startActivity(intent);
                break;
        }
    }
    ...
    public void setListViewDeleteBtn() {
        ...
        studnetskillgame_lv.setMenuCreator(menuCreator);
        studnetskillgame_lv.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            @Override
