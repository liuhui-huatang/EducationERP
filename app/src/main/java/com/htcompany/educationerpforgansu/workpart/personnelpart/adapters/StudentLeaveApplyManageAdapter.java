 ...
 */
public class StudentLeaveApplyManageAdapter extends BaseAdapter{
    private Context context;
    private LayoutInflater inflater;
    private List<StudentLeaveApplyEntity> datas;
    public StudentLeaveApplyManageAdapter(Context context, List<StudentLeaveApplyEntity> datas){
...
//                .into(vh.leaveapplymanage_photo_img);
        vh.leaveapplymanage_name_tv.setText(datas.get(position).getTruename());
//        status 3审核通过，2审核未通过，1已提交
        if("审核通过".equals(datas.get(position).getTrbd_qjstatus())) {
            vh.leaveapplymanage_zt_tv.setText(datas.get(position).getTrbd_qjstatus());
        ...
        }else if("已提交".equals(datas.get(position).getTrbd_qjstatus())) {
            vh.leaveapplymanage_zt_tv.setText(datas.get(position).getTrbd_qjstatus());
        ...
        }else if("审核未通过".equals(datas.get(position).getTrbd_qjstatus())) {
            vh.leaveapplymanage_zt_tv.setText(datas.get(position).getTrbd_qjstatus());
        ...
        }else if("已销假".equals(datas.get(position).getTrbd_qjstatus())) {
            vh.leaveapplymanage_zt_tv.setText(datas.get(position).getTrbd_qjstatus());
        ...
        vh.leaveapplymanage_zt_tv.setText(datas.get(position).getTrbd_qjstatus());
            vh.leaveapplymanage_type_tv.setText(datas.get(position).getTrbd_type());
        vh.leaveapplymanage_time_tv.setText(datas.get(position).getStart_time()+"至"+datas.get(position).getEnd_time());
        return convertView;
    }
    class ViewHodler{
        public TextView leaveapplymanage_name_tv,leaveapplymanage_zt_tv,leaveapplymanage_type_tv,
                leaveapplymanage_time_tv;
        public XCRoundAndOvalImageView leaveapplymanage_photo_img;
