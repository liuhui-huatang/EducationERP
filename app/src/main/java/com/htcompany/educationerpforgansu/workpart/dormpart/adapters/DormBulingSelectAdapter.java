 ...
 */
public class DormBulingSelectAdapter extends BaseAdapter{
    private Context context;
    private LayoutInflater inflater;
    private List<DormBulingEntitiy> datas;
    public DormBulingSelectAdapter(Context context,List<DormBulingEntitiy> datas){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.importitlselectortitile_tv.setText(datas.get(position).getBuilding_name());
        return convertView;
    }
    class ViewHodelr{
