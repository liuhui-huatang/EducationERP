 ...
 */
public class ClassTableTimeActivity extends BaseActivity implements View.OnClickListener{
    ...
    private MyClassSelectEntity entity=null;
    //网络请求类
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.right_btn:
                //选择周次
                weekSelectPopWindow = new WeekSelectPopWindow(ClassTableTimeActivity.this,weeksEntities,tableHanler);
       ...
       public void handleMessage(Message msg) {
           ...
           switch (msg.what){
               case 1000:
                   ...
                   teacherInternet.getBZRTableDatas((String)msg.obj,entity.getKey());
                   break;
               case 200:
                   //网络请求成功，解析数据
               ...
               case 300:
                   ...
                   ToastUtil.showToast("数据异常",ClassTableTimeActivity.this);
                   break;
               case 400:
                   if(waitDialog!=null){
                       waitDialog.dismiss();
                   }
                   ToastUtil.showToast("连接服务器失败",ClassTableTimeActivity.this);
                   break;
           }
       }
   };
