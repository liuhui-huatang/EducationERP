 ...
 */
public class MyMeetingFailedDetailsActivity extends BaseActivity implements View.OnClickListener{
    private TextView title;
    private RelativeLayout reback_btn;

    private TextView meetingfaileddetials_shr_tv,meetingfaileddetials_shtime_tv,meetingfaileddetials_shsbyy_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meetingfaileddetails_activity);
        initDatas();
        initViews();
        initViewValues();
        initOnclicEvents();
    ...
    public void initViews(){
        ...
        meetingfaileddetials_shr_tv= (TextView)this.findViewById(R.id.meetingfaileddetials_shr_tv);
        meetingfaileddetials_shtime_tv= (TextView)this.findViewById(R.id.meetingfaileddetials_shtime_tv);
        meetingfaileddetials_shsbyy_tv= (TextView)this.findViewById(R.id.meetingfaileddetials_shsbyy_tv);
...
//        rymdAdapter = new MeetingDetailsRYMDAdapter(MyMeetingFailedDetailsActivity.this,personEntities);
...
//
//            meetingfaileddetials_shr_tv.setText(myMeetingEntity.getMshr());
//            meetingfaileddetials_shtime_tv.setText(myMeetingEntity.getMshtime());
//            meetingfaileddetials_shsbyy_tv.setText(myMeetingEntity.getMshsbyu());
//
