 ...
 */
public class EducationTeacherTrainingDtailsActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.edu_jspxxm_ll:
                Intent intent = new Intent(EducationTeacherTrainingDtailsActivity.this,EducationTeacherTrainingProjectDtailsActivity.class);
