...
/**
 * Created by 教师评教 on 2017/2/23.
 */
public class TeacherPJActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initDatas(){
        ...
        url = url+"token="+sharedPrefUtil.getString("token","");;
    }
