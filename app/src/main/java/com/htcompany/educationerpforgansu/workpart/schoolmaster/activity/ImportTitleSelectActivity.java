...
import com.htcompany.educationerpforgansu.workpart.schoolmaster.adapter.ImportTitleSelectAdapter;
 ...
 */
public class ImportTitleSelectActivity extends BaseActivity implements View.OnClickListener{
    private TextView title;
    private RelativeLayout reback_btn;
    private ListView alladdress_lv;
    private ImportTitleSelectAdapter titleSelectAdapter;
    ...
    public void initDatas(){
        ...
        waitDialog.show();
        if("BZR".equals(flag)){
            materInternet.getBZRKH_title_ListDatas();
        }else if("PTJS".equals(flag)){
            materInternet.getPTJSKH_title_ListDatas();
    ...
    public AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ImportTitleEntity entity = (ImportTitleEntity) titleSelectAdapter.getItem(position);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 400:
                    ...
                    ToastUtil.showToast("连接超时",ImportTitleSelectActivity.this);
                    break;
                case 200:
                    if(waitDialog!=null){
                        waitDialog.dismiss();
                    }
                     datas = materPersener.parseBZRKH_TITLE_LISTData((String)msg.obj);
                    if(datas!=null&&datas.size()>0){
                        titleSelectAdapter= new ImportTitleSelectAdapter(ImportTitleSelectActivity.this,datas);
                ...
                case 300:
                    ...
                    ToastUtil.showToast("数据异常",ImportTitleSelectActivity.this);
                    break;
            }
        }
    };
