 ...
 */
public class MyMeetingWaitUploadDetialsActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meetingwaituploaddetials_activity);
        initDatas();
        initViews();
        initViewValues();
        initOnclicEvents();
...
//        rymdAdapter = new MeetingDetailsRYMDAdapter(MyMeetingWaitUploadDetialsActivity.this,personEntities);
...
//            meetingdetails_status_tv.setText("待提交");
