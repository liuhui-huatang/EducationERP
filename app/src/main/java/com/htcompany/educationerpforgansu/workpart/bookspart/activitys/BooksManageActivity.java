...
import com.htcompany.educationerpforgansu.workpart.bookspart.adapters.BooksManageAdapter;
 ...
 */
public class BooksManageActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener {
    ...
    public void initDatas(){
        ...
        waitDialog.show();
        booksInternet.getBooks_LISTDatas(String.valueOf(pageNum),sea_name,sea_bookcategory);
    }
    ...
    public AdapterView.OnItemClickListener bookManageClicer = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            intent = new Intent(BooksManageActivity.this, BooksDetiasActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.right_three_btn:
                //调到图书分类界面
                intent = new Intent(BooksManageActivity.this, BooksTypesActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 400:
                    ...
                    ToastUtil.showToast("连接超时",BooksManageActivity.this);
                    break;
                case 200:
                    if(waitDialog!=null){
                        waitDialog.dismiss();
                ...
                case 300:
                    ...
                    ToastUtil.showToast("数据异常",BooksManageActivity.this);
                    break;
            }
        }
    };
     ...
     * @param datas
     */
    public void setLVDatas(List<BookEntity> datas){
        if(pageNum==1){
            if(bookEntities.size()>0){
                bookEntities.clear();
            }
