 ...
 */
public class EducationStudentPJAddBJMDAdapter extends BaseAdapter{
    private Context context;
    private LayoutInflater inflater;
    private List<AllClassEntity> datas;
    public EducationStudentPJAddBJMDAdapter(Context context,List<AllClassEntity> datas){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.meetingapllychry_name_tv.setText(datas.get(position).getCname());
        return convertView;
    }
    class ViewHoder{
