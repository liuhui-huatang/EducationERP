 ...
 */
public class MyMeetingOverDetailsActivity extends BaseActivity implements View.OnClickListener{
    private TextView title;
    private RelativeLayout reback_btn;

    private TextView meetingoverdetails_shr_tv,meetingoverdetails_shtime_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meetingoverdetails_activity);
        initDatas();
        initViews();
        initViewValues();
        initOnclicEvents();
    ...
    public void initViews(){
        ...
        meetingoverdetails_shr_tv= (TextView)this.findViewById(R.id.meetingoverdetails_shr_tv);
        meetingoverdetails_shtime_tv= (TextView)this.findViewById(R.id.meetingoverdetails_shtime_tv);
...
//        rymdAdapter = new MeetingDetailsRYMDAdapter(MyMeetingOverDetailsActivity.this,personEntities);
...
//
//            meetingoverdetails_shr_tv.setText(myMeetingEntity.getMshr());
//            meetingoverdetails_shtime_tv.setText(myMeetingEntity.getMshtime());
//
