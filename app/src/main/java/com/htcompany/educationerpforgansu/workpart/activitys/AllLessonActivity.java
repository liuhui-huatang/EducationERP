...
import com.htcompany.educationerpforgansu.workpart.adapters.AllLessonAdapter;
 ...
 */
public class AllLessonActivity extends BaseActivity implements View.OnClickListener{
    private TextView title;
    private RelativeLayout reback_btn;
    private ListView alladdress_lv;
    private AllLessonAdapter lessonAdapter;
    private List<AllLessonEntity> lessonEntities;
    //网络请求类
    private WorkTeacherInternet teacherInternet;
    private WorkTeacherPersener teacherPersener;
    private WaitDialog waitDialog=null;
    private String term="",weeks="";
    @Override
    ...
    public AdapterView.OnItemClickListener clicer = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            AllLessonEntity entity = (AllLessonEntity) lessonAdapter.getItem(position);
            if(entity!=null){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 400:
                    ...
                    ToastUtil.showToast("连接超时",AllLessonActivity.this);
                    break;
                case 200:
                    if(waitDialog!=null){
                        waitDialog.dismiss();
                    }
                    List<AllLessonEntity> datas = teacherPersener.parseLessonLSITData((String)msg.obj);
                ...
                case 300:
                    ...
                    ToastUtil.showToast("数据异常",AllLessonActivity.this);
                    break;
            }
        }
    };
     ...
     * @param datas
     */
    public void setLVDatas(List<AllLessonEntity> datas){
        if(lessonEntities.size()>0){
            lessonEntities.clear();
        }
        for(AllLessonEntity entity:datas){
